...
<div class="col-7">
<h3><a href="sign_pat.php"><samp>Patient please sign Up</samp></a></h3><br><br>
...
$select = "SELECT * FROM sign_pat WHERE puser_name='$U_name'";
$query  = mysqli_query($conn,$select);
$numrows = mysqli_num_rows($query);

if($numrows == 0)
{
$sql = "INSERT INTO `sign_pat`(`pfirst_name`, `plast_name`, `puser_name`, `pGender`, `pE_mail`, `pmobile`, `ppassword`) VALUES ('$f_name','$l_name','$U_name','$gender','$email','$cont','$pass')";
