...
<p><a href = "sign_doc.php">Doctors registration form</a> | <a href = "login_doc.php">Doctors Login form</a></p>
...
$select = "SELECT * FROM sign_doc WHERE user_name='$user'";
