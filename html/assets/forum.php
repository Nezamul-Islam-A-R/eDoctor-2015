...
.col-5{width: 41.66%;}
.col-6{width: 50%;}
.col-7 {width: 54.33%;height: 500px;border: 3px solid #000; margin-right: 4%;}
.col-8 {width: 66.66%;}
.col-9 {width: 75%;}
.col-10 {width: 83.33%;}
.col-11 {width: 91.66%;}
...
<div class="col-7">
<center><samp><h4><span style="color:red">_ _ _ _ _PLEASE LOG IN TO SEE FORUM_ _ _ _ _</span></h4></samp></center>
</div>
