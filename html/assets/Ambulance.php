...
<image src="images\docdpt1.gif" alt="Doctors Department" style="width:60px height:60px; padding-left: 10px;padding-top: 10px ">
<samp>   1. Ad-Din Hospital,	Phone: 9362929</samp>
</div>
<div class="DocListBack2">
<image src="images\docdpt1.gif" alt="Doctors Department" style="width:60px height:60px; padding-left: 10px;padding-top: 10px ">
<samp>   2. Al-Markazul Islami Ambulance Service Phone: 9127867, 8114980</samp>
</div>
<div class="DocListBack">
<image src="images\docdpt1.gif" alt="Doctors Department" style="width:60px height:60px; padding-left: 10px;padding-top: 10px ">
<samp>   3. Alif Ambulance Phone: 8117576 , 9131688</samp>
</div>
<div class="DocListBack2">
<image src="images\docdpt1.gif" alt="Doctors Department" style="width:60px height:60px; padding-left: 10px;padding-top: 10px ">
<samp>   4. Anjuman-E-Mufidul Islam Phone: 9336611, 7411660, 7410786</samp>
</div>
<div class="DocListBack">
<image src="images\docdpt1.gif" alt="Doctors Department" style="width:60px height:60px; padding-left: 10px;padding-top: 10px ">
<samp>   5. Apanjon Ambulance Service Phone: 9125420
</samp>
</div>
<div class="DocListBack2">
<image src="images\docdpt1.gif" alt="Doctors Department" style="width:60px height:60px; padding-left: 10px;padding-top: 10px ">
<samp>   6. BIRDEM Phone: 9661551-60, 8616641-50, Ext-2301</samp>
</div>
...
<h4></h4>
<samp><span style="color: blue">Developer & Admin Console</span><br><br></samp>
<var>Name : N.I.Md. Ashafuddula<br></var>
<samp>Occupation: Study<br></samp>
<samp>Institution: <a href="http://www.ruet.ac.bd">Rajshahi University Of Engineering & Technology</a><br></samp>
<samp>Mobile: 01932082303<br></code>
<samp>Address: Shahidul hall,RUET<br></code>
<samp>Facebook: <a href="https://www.facebook.com/nezamulislam.ar?_rdr=p">এন আই আসাফুদ্দৌলা রাজন</a></samp>
</div>
...
<h4></h4>
<samp><span style="color: blue">Admin Console</span><br><br></samp>
<var>Name : Nezamul Islam A R<br></var>
<samp>Occupation: Study<br></samp>
<samp>Institution: <a href="http://rmcbd.net">Rajshahi Mediacal College</a><br></samp>
<samp>Mobile: 01932082303<br></samp>
<samp>Address: Shahidul hall,RMC<br></samp>
<samp><br>Facebook: <a href="https://www.facebook.com/nezamulislam.ar?_rdr=p">এন আই আসাফুদ্দৌলা রাজন</a></samp>
</div>
...
<samp>Occupation: Study<br></samp>
<samp>Institution: <a href="http://www.dmc.edu.bd">Dhaka Mediacal College</a><br></samp>
<samp>Mobile: 01932082303</samp>
<samp><br></samp>
<samp>Address: Shahidul hall,DMC<br></samp>
<samp><br>Facebook: <a href="https://www.facebook.com/nezamulislam.ar?_rdr=p">এন আই আসাফুদ্দৌলা রাজন</a></samp>
</div>
